...
public enum ErrorCode {
    ...
    NOTIFICATION_EVENT_NOT_FOUND(HttpStatus.NOT_FOUND, "NOTIFICATION_EVENT_NOT_FOUND", "알림 이벤트를 찾을 수 없습니다."),
    OUTBOX_PUBLISH_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "OUTBOX_PUBLISH_FAILED", "Outbox publish에 실패했습니다."),
    OUTBOX_EVENT_NOT_FOUND(HttpStatus.NOT_FOUND, "OUTBOX_EVENT_NOT_FOUND", "Outbox 이벤트를 찾을 수 없습니다."),
    ADMIN_REPROCESS_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "ADMIN_REPROCESS_NOT_ALLOWED", "현재 상태에서는 재처리할 수 없습니다."),
